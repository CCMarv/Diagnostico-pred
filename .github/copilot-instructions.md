...
El plan de correcciones vigente está en `docs/PLAN_CORRECIONES.md`.
Antes de implementar cualquier tarea, leer ese archivo completo.
Las fases son secuenciales: no iniciar Fase N si Fase N-1 tiene tareas sin completar.
